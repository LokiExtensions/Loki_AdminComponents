...
![Latest Version](https://img.shields.io/packagist/v/loki/magento2-admin-components)
<!-- badges.specs.end -->
...
<!-- badges.test.start -->
![Static Tests](https://img.shields.io/github/actions/workflow/status/LokiExtensions/Loki_AdminComponents/static-tests.yml?label=static-tests)
![Unit Tests](https://img.shields.io/github/actions/workflow/status/LokiExtensions/Loki_AdminComponents/unit-tests.yml?label=unit-tests)
![Integration Tests](https://img.shields.io/github/actions/workflow/status/LokiExtensions/Loki_AdminComponents/integration-tests.yml?label=integration-tests)
![Playwright](https://img.shields.io/github/actions/workflow/status/LokiExtensions/Loki_AdminComponents/playwright.yml?label=playwright)
![DI Compilation](https://img.shields.io/github/actions/workflow/status/LokiExtensions/Loki_AdminComponents/compile.yml?label=compile)
<!-- badges.test.end -->
